<?php
	...
	switch ($cmd) {
		...
		case '/reservar':	
			...
			$cmd_param2=$params[1];
			$cmd_param3=$params[2];
			$url = "http://grupo13.herokuapp.com/api/turns/$cmd_param1/$cmd_param2/$cmd_param3";
		...
		case '/turnos':
			if ($cmd_params!=''){
			$turnosDisp = file_get_contents("http://grupo13.herokuapp.com/api/turns/$cmd_params");
	...
	$url = 'https://api.telegram.org/bot528189493:AAGNg3HIdLS_SxtfiJf32Fm46Owj-rH5_ns/sendMessage';
